...
def parse_args():
    ...
    parser.add_argument("--robust-plr", type=lambda x: bool(strtobool(x)), default=False, nargs="?", const=True,
                        help="if toggled, this experiment will use robust prioritized level replay")
    ...
    if args.curriculum:
        ...
        if args.curriculum_method == "plr":
            ...
            curriculum = PrioritizedLevelReplay(
                ...
                eval_envs=sample_env.eval_envs,
