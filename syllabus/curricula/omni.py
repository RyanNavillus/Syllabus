...
class OMNI(LearningProgress):
    def __init__(self, *args, interestingess: Dict = None, **kwargs):
        ...
        if interestingess is None:
            ...
            self.post_task_interestingness = interestingess

    def set_interestingess(self, interestingess: Dict) -> None:
        """Set the interestingness dictionary for the curriculum.

        :param interestingess: Dictionary mapping evaluated tasks to interestingness dictionaries
        """
        self.post_task_interestingness = interestingess
