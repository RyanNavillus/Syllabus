...
from syllabus.tests import test_single_process, test_native_multiprocess, test_ray_multiprocess, create_simpletag_env, create_pistonball_env, get_test_values
...
if __name__ == "__main__":
    ...
    curricula = [
        ...
        (PrioritizedLevelReplay, create_pistonball_env, (pistonball_env.task_space, pistonball_env.observation_space), {"get_value": get_test_values, "device": "cpu", "num_processes": N_ENVS*len(pistonball_env.possible_agents), "num_steps": 2048}),
