...
from syllabus.tests import test_single_process, test_native_multiprocess, test_ray_multiprocess, create_pettingzoo_synctest_env
...
if __name__ == "__main__":
    ...
    ray_syllabus_speed = test_ray_multiprocess(create_pettingzoo_synctest_env, env_args=(N_EPISODES,), num_envs=N_ENVS, num_episodes=N_EPISODES)
